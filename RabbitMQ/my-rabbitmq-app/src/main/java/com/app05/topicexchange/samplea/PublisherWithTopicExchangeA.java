...
public class PublisherWithTopicExchangeA {

    private static String EXCHANGE_NAME = "quotes_exchange_topic";
    private static String ROUTING_KEY = "small.car.insurance";
    private static String ROUTING_KEY2 = "home.insurance";
    private static String ROUTING_KEY3 = "insurance";
