...
For  multiple consumers roundRobin is applied
1) consumer will take messages 1,3,5
2) consumer will take messages 2,4,6

 */

public class Consumer02BasicSecondConsumer {
